...
function setBrush() {
    ...
    canvas.onmousedown = function (e) {
        addUndo();
        flag = true;
        beginPoint = [e.pageX, e.pageY];
        points.push(beginPoint);
    }
    canvas.onmousemove = function (e) {
        var endPoint = [e.pageX,  e.pageY]
        if (flag) {
...
function drawLine(beginPoint, controlPoint, endPoint) {
    cxt.beginPath();
    cxt.moveTo(beginPoint[0], beginPoint[1]);
    cxt.quadraticCurveTo(controlPoint[0], controlPoint[1], endPoint[0], endPoint[1]);
    cxt.stroke();
    cxt.closePath();
}
